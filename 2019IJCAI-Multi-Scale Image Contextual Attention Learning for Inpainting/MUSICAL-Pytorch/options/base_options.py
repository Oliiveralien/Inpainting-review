...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='shiftnet',
                                 help='chooses which model to use. [shiftnet|soft_shiftnet|test]')
        ...
        parser.add_argument('--CA_type', type=str, default="single", help='what type of contextual module to use. single, parallel and serial')
