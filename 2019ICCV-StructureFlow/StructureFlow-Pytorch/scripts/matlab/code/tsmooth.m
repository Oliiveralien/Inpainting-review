function S = tsmooth(I,lambda,sigma,sharpness,maxIter,mask)
%tsmooth - Structure Extraction from Texture via Relative Total Variation
%   modified for StructureFlow image inpainting.
%   S = tsmooth(I, lambda, sigma, maxIter, mask) extracts structure S from
...
%   @mask      : The mask of input image of inpainting task.
%            
%   Example
%   ==========
...
% 
    ...
    dec=2.0;
    for iter = 1:maxIter
        [wx, wy] = computeTextureWeights(x, mask, sigma_iter, sharpness);
